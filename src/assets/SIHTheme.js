...
// React Icons Import Use:   yarn add react-icons
    ...
    ps: [
      {
        ...
        Problem_Statement_Title:
          "Developing an AI-powered energy management system for industrialcommercial facilities to optimize energy consumption.",
        Description:
      ...
      },
      {
        Organization: "Ministry of power ",
        Problem_Statement_Title:
          "Language translator tool to convert English toHindi (official Language) which can be used by all the government organizationswebsites officially.",
        Description:
      ...
      },
      {
        Organization: "Ministry of coal ",
        Problem_Statement_Title:
          "Real-time visibility of Dumper load status to Shoveloperator",
        Description:
      ...
      },
      {
        Organization: "Ministry of coal ",
        Problem_Statement_Title:
          "Development of a Digital Platform for multi-modal visibility of coaltransportation",
        Description:
      ...
      },
      {
        ...
        Problem_Statement_Title:
          "Udyog Saarthi App - (Progressive Web-based Application) forAdults undergoing Job coaching for opportunities under 4% reservation in NIEPMD and otherInstitutions.",
        Description:
      ...
      },
      {
        ...
        Problem_Statement_Title:
          "Natural language translation engine forannouncements and information dissemination at stations",
        Description:
          "Design ofa system to provide information in a desired Indian language ondemand by passengers and other customers, in written and oral form. The system shouldbe extendable to foreign languages for tourists as and when required. Limited vocabularysystems for commonly required railway information services are acceptable.Scope ofthe system - announcements at stations, information over IVRS, informationthrough chatbots and web interfaces.constraints to be considered - voice recognition in different languages; noisy ambienceat stations; adequate computing power for on-the-fly content generation; delivery onmobile devices.",
        Category: "Software ",
        PS_Number: "SIH1348",
        Domain_Bucket: "Smart Automation",
      },
      {
        Organization: "Ministry of Railways ",
        Problem_Statement_Title:
          "Using existing CCTV network for crowd management, crime prevention, andwork monitoring using AIiML",
        Description:
      ...
      },
      {
        Organization: "Government of Jammu and Kashmir ",
        Problem_Statement_Title:
          "Digital Generator Monitoring Diesel generators are widely used as backup power sources in industries, homes, and remote locations",
        Description:
      ...
      },
      {
        Organization: "Ministry of Power ",
        Problem_Statement_Title:
          "Creation of Live Digital Twins for the powerProjects and integration with all existingmonitoring and database system which will give aholistic real time approach to the project and plantfrom all aspect of construction, operation andmaintenance.",
        Description:
      ...
      },
      {
        ...
        Description:
          "A software that allows the ministry to monitor the success of theirbehavioural nudges in real time with respect to consumer choices andenvironmentally friendly actions. The software will define certain measurableoutcome indicators and track the changes in them over time. The changes will becorrelated to LiFE activities and awareness programmes to measure the successof the behavioural nudges.",
        Category: "Software ",
        PS_Number: "SIH1391",
        Domain_Bucket: "Smart Automation",
      },
      ...
      },
      {
        ...
        Problem_Statement_Title:
          "AR/VR based application which helps visualize the complete house virtually at an early stage, which can help in cost estimation, planning andcompletion of the house in time'",
        Description:
          "AR/VR technology based solution will help the beneficary to get a virtual miniature of the completed house at an early stage and will also give an estimate of the cost so that the beneficiary can do thenecessary planning before starting the construction.",
        Category: "Software ",
        PS_Number: "SIH1428",
        Domain_Bucket: "Smart Automation",
      },
      {
        Organization: "Ministry of Rural Development ",
        Problem_Statement_Title:
          "Develop a solution to identifo discrepancies in Quality Monitoring Data on OMMAS and generate reports that highlight areas wherecorrective action is Required.",
        Description:
      ...
      },
      {
        ...
        Problem_Statement_Title:
          "Students to use Autodesk Fusion 360 to research and to generate NC code with machine details and tool library for any industrial component. For additional information and detailed problem statement",
        Description:
      ...
      },
      {
        ...
        Problem_Statement_Title:
          "Centralized Monitoring System for Street LightFault Detection and Location Tracking",
        Description:
      ...
      },
      {
        Organization: "Ministry of Housing and Urban Affairs ",
        Problem_Statement_Title:
          "Suggest an Al-based solution to enable ease of grievance lodging and tracking forcitizens across multiple departments",
        Description:
  ...
  },
  {
    ...
    ps: [
      ...
      },
      {
        ...
        Problem_Statement_Title:
          "Development of business models for collection and utilization of single usc plastics and various other industrial wastes",
        Description:
      ...
      },
      {
        Organization: "Ministry of Micro, Small and Medium Enterprises ",
        Problem_Statement_Title:
          "Development of Technology for manufacturing of mind control BIONIC hand with a sense of touch",
        Description:
    ...
    ps: [
      {
        ...
        Problem_Statement_Title:
          "Automatic regulation of valves for release of water based upon soil moisture availability inthe root zone of the crop, using artificial intelligence, in a piped and micro irrigation network ofirrigation system.",
        Description:
      ...
      },
      {
        Organization: "Government of Jammu and Kashmir ",
        Problem_Statement_Title:
          "Traditional agriculture practices lack real-time monitoring and efficient operation on fields This leads to inefficiencies and low production levels.",
        Description:
      ...
      },
      {
        ...
        Description:
          "To provide a sustainable solution with regards to dairy plant operation and performance, the monitoring of plant's energy demand per unit of produce would be an essential parameter. Monitoring of plant hygiene and sanitation would play a key role through the perspective of improvements in food safety. On the consumer end of dairy product value chain, the efficient and easy mechanism for collection of packaging waste is very important aspect.It is the need of the time to have one-stop solution which would address the above mentioned aspects reliably with an integrated approach.Solution may be developed preferably based upon software integrated with associated hardware.",
        Category: "Hardware",
        PS_Number: "SIH1373",
        Domain_Bucket: "Agriculture, FoodTech & Rural Development",
      },
      {
        ...
        Description:
          "The idea is to create a system that would keep a track on growth rate andexistence of the plantation in the CAT (Catchment Area Treatment ) area. Itwould also check illegal forest activities.",
        Category: "Hardware",
        PS_Number: "SIH1375",
        Domain_Bucket: "Agriculture, FoodTech & Rural Development",
      },
      ...
      },
      {
        Organization: "Ministry of Micro, Small and Medium Enterprises ",
        Problem_Statement_Title:
          "IoT based sensors can be used to determine the Machine Runtime",
        Description:
      ...
      },
      {
        Organization: "Ministry of Micro, Small and Medium Enterprises ",
        Problem_Statement_Title:
          "lntegration and Utilization of data-based being maintained by various Ministries/Departments for better utilization of raw materials and production capacity.",
        Description:
  ...
  },
  {
    ...
    ps: [
      ...
      },
      {
        Organization: "Ministry of coal ",
        Problem_Statement_Title:
          "In-cab smart guidance and support system for DraglineOperator",
        Description:
  ...
  },
  {
    ...
    ps: [
      ...
      },
      {
        ...
        Description:
          "There are more than 18,000 nos. of poly pulleys along the conveyor length whichundergo wear and tear and need replacements including emergency replacements stoppingthe conveyor system.Solution Desired: Based on past data and the use of suitable ML software, the pulley failures withits locations can be predicted which would help in avoiding sudden stoppages of the conveyor.",
        Category: "Software ",
        PS_Number: "SIH1338",
        Domain_Bucket: "Transportation & Logistics",
      },
      ...
      },
      {
        ...
        Problem_Statement_Title: "Student Innovation",
        Description:
          "Submit your ideas to address the growing pressures on the city‚ resources, transport networks, and logistic infrastructure",
        Category: "Hardware",
        PS_Number: "SIH1476",
        Domain_Bucket: "Transportation & Logistics",
      },
      ...
      },
      {
        ...
        Description:
          "The 14.6 km long cable belt conveyor passing over complex hilly terrain suffersbelt dislodgements due to various reasons resulting in the sudden loss of production.Solution Desired: Capture reasons for belt dislodgements across its 14.6 KM length from pastdata and using suitable ML software, prediction of belt dislodgements should be donebeforehand to take corrective and preventive actions.",
        Category: "Hardware",
        PS_Number: "SIH1507",
        Domain_Bucket: "Transportation & Logistics",
      },
  ...
  },
  {
    ...
    ps: [
      ...
      },
      {
        ...
        Description:
          "Cochin Port is having water bodies and a land area of 2177 acres.Licenses are being issued by the Port to the marine vessels to ply within the Port limit.A cost-effective solution is required to:i. Tracking and reporting of harbor crafts like boats, barges, dinghies, etc., that ply in the Port water limit.ii. Encroachments if any, in the port limits need to be watched constantly and report the same if any.iii. Management Information System regarding the violators, encroachments, etc.",
        Category: "Hardware",
        PS_Number: "SIH1310",
        Domain_Bucket: "Robotics and Drones",
      },
      ...
      },
      {
        Organization: "Ministry of Power ",
        Problem_Statement_Title:
          "Robotics for inspection of abrasion / corrosion ofunderwater equipment / parts and further repair and maintainance",
        Description:
  ...
  },
  {
    ...
    ps: [
      ...
      },
      {
        Organization: "Ministry of Power ",
        Problem_Statement_Title:
          "Design of CYBER-SECURITY ENABLED SMART CONTROLLER for grid-connectedMicrogrid",
        Description:
      ...
      },
      {
        Organization: "Government of Gujarat ",
        Problem_Statement_Title:
          "Online Blockchain based certificate generation and validationsystem for government organization.",
        Description:
      ...
      },
      {
        Organization: "Ministry of power ",
        Problem_Statement_Title:
          "Detection of embedded Malware/ Trojan in hardware devicesused in Power Sector.",
        Description:
      ...
      },
      {
        Organization: "Ministry of power ",
        Problem_Statement_Title:
          "To develop centralised information security .Log-collectionfacility' or 'security operation centre (soc)' in the power sector, considering cEAcybersecurity (Power sector) Guidelines, 2021to keep lr and or networking System isolatedand air-gapped.",
        Description:
      ...
      },
      {
        Organization: "National Technical Research Organisation,(NTRO) ",
        Problem_Statement_Title:
          "De-anonymisation for monitoring and tracking of illegalactivities performed using cryptocurrency transaction technology",
        Description:
  ...
  },
  {
    ...
    ps: [
      ...
      },
      {
        Organization: "Ministry of Law and Justice ",
        Problem_Statement_Title:
          "Digital Assistant for Legal Awareness and Designing a KYC frameworkin India",
        Description:
      ...
      },
      {
        Organization: "Ministry of Jal Shakti ",
        Problem_Statement_Title:
          "Development of AI, ML and Chat boat-powered Interactive Robot Mascot (Chacha Chaudhary)and digital avatar to strengthen the river people connect component of Namami Gange.",
        Description:
      ...
      },
      {
        Organization: "Government of Kerala ",
        Problem_Statement_Title:
          "Ideate and implement a system to enhance the quality of education in ruralareas.",
        Description:
      ...
      },
      {
        Organization: "Government of Jammu and Kashmir ",
        Problem_Statement_Title:
          "Using technology to develop a moving/mobile education system/software or equipment so that the children of nomadic communities such as Bakarwals /Gujjars can have proper education at least till primary.",
        Description:
      ...
      },
      {
        Organization: "Ministry of Social Justice and Empowerment ",
        Problem_Statement_Title:
          "To develop a technical solution for enabling Institution level verification of students of one State studying in other State/s, who are at present generallydenied benefits under the Scholarship scheme as the Institutions in which theyare studying are not registered on the portal/s of their home State.",
        Description:
          "To develop a technical solution for enabling Institution level verification ofstudents of one State studying in other State/s, who are at present generallydenied benefits under the Scholarship scheme as the Institutions in which theyare studying are not registered on the portal/s of their home State.",
        Category: "Software ",
        PS_Number: "SIH1367",
        Domain_Bucket: "Smart Education",
      },
      ...
      },
      {
        Organization: "Ministry of Education ",
        Problem_Statement_Title:
          "Identify slow learners for remedial teaching and capacity buildingfor innovative methods.",
        Description:
      ...
      },
      {
        Organization: "Ministry of Education ",
        Problem_Statement_Title:
          "Mental health and well-being surveillance, assessment andtracking solution among children.",
        Description:
      ...
      },
      {
        Organization: "Ministry of Education ",
        Problem_Statement_Title:
          "Making career choices and AI based counselling accessible toevery child at secondary level along with aptitude tests anddetailed career paths.",
        Description:
  ...
  },
  {
    ...
    ps: [
      ...
      },
      {
        Organization: "Ministry of Jal Shakti ",
        Problem_Statement_Title:
          "A mobile app that crowd sources water-related problems from around a community, opensources data, etc. and display them on a map.",
        Description:
      ...
      },
      {
        Organization: "Ministry of Jal Shakti ",
        Problem_Statement_Title:
          "Estimation of inflow to a reservoir from the rainfall considering soil moisture in its catchmentand releases from upstream reservoirs and automatically opening of reservoir gates for moderatelyreleasing the water to avoid the flooding in a basin.",
        Description:
      ...
      },
      {
        ...
        Description:
          "Design and Development of AI-ML based intelligent de-smoking/de-hazing algorithm for reproducing the realtime video of the area under fire specifically for indoorfire hazards to aid the rescue operation.",
        Category: "Software ",
        PS_Number: "SIH1417",
        Domain_Bucket: "Disaster Management",
      },
      ...
      },
      {
        Organization: "Ministry of Home Affairs ",
        Problem_Statement_Title:
          "Areal Location of Hazardous Atmosphere in Industries",
        Category: "Software",
        PS_Number: "SIH1505",
        Domain_Bucket: "Disaster Management",
      },
  ...
  },
  {
    ...
    ps: [
      ...
      },
      {
        Organization: "Ministry of Law and Justice ",
        Problem_Statement_Title:
          "Incentives based Design for onboarding Legal Service Providers such as Advocates,Arbitrators, Mediators, Notaries, Document Writers, etc on eMarket Place for extendingLegal Services to Citizens in India",
        Description:
      ...
      },
      {
        Organization: "Government of Punjab ",
        Problem_Statement_Title:
          "PGRKAM web application ( www.pgrkam.com) and the PGRKAMAndroid application of the Punjab Government provides employmentdata to the prospective candidates.",
        Description:
      ...
      },
      {
        Organization: "Government of Punjab ",
        Problem_Statement_Title:
          "PGRKAM web application ( www.pgrkam.com) and the PGRKAMAndroid application of the Punjab Government provides employmentdata to the prospective candidates. The platform has a sizeable number of userbase but it lacks integrated analytics tools to understand how the usersare consuming the information.",
        Description:
      ...
      },
      {
        Organization: "Ministry of coal ",
        Problem_Statement_Title:
          "Application of Image Analytics for Tree enumeration fordiversion of Forest Land.",
        Description:
      ...
      },
      {
        ...
        Description:
          "Details of counselling and De-Addiction interventions provided to thebeneficiaries at facilities supported by MoSJE is not available on a singleplatform, which could help in analysis of patient-wise, center- wise or State-wise details of services provided, beneficiaries reachedand other relevantdetails.",
        Category: "Software ",
        PS_Number: "SIH1366",
        Domain_Bucket: "Miscellaneous",
      },
      ...
      },
      {
        ...
        Description:
          "Vision based methods using deep learning such as CNNto perform terrain recognition(sandy/rocky/grass/marshy) enhanced with implicitquantities information such as the roughness,slipperiness, an important aspect for high-levelenvironment perception.",
        Category: "Software ",
        PS_Number: "SIH1418",
        Domain_Bucket: "Miscellaneous",
      },
      {
        ...
        Description:
          "Robust human target detection and acquisition/lockingwithout losing track under occlusions for outdooroperational scenarios. Visuals alarm generation uponanomaly detection (i.e human jumping/ crawling/running).",
        Category: "Software ",
        PS_Number: "SIH1419",
        Domain_Bucket: "Miscellaneous",
      },
      {
        Organization: "Ministry of Defence ",
        Problem_Statement_Title:
          "Lean module for reasoning about computational complexity inGPTs.",
        Description:
      ...
      },
      {
        ...
        Description:
          "With increase in education and awareness levels aroundMenstrual Health and Hygiene, more and more women andadolescent girls in the country are switching to safe sanitaryoptions to manage their menstrual cycles. However, there is stillno formal waste management system of sanitary waste. Oftenthese are disposed off in fields, water bodies, flushed in toilets ordumped along with the regular solid waste.Solutions to manage and dispose of sanitary waste. The solutionsshould be: Safe for the environment, and not cause any air, water orsoil pollution Cost-effective Scalable across villages and institutions such as schools,colleges, etc.",
        Category: "Hardware",
        PS_Number: "SIH1426",
        Domain_Bucket: "Miscellaneous",
      },
      ...
      },
      {
        Organization: "National Technical Research Organisation,(NTRO) ",
        Problem_Statement_Title:
          "Speech to text transcription for Indian languages. Theproblem entails transcription in the native script and then translation to English. Thelanguages of interest are Hindi, Indian English, Urdu, Bengali, Punjabi.",
        Description:
          "The problem entails transcription of audio files to the native script ofthe audio and then translation to English. The languages of interest are asmentioned below. A key element to be considered is that the solution would berequired to be tuned for Indian accents. The languages of interest for the problemstatement are shown below: Hindi Indian English Urdu Bengali PunjabiDatasets pertaining to theses languages will be provided by us, which will consist oftwo major chunks of data: Training Set and a hidden test set. The participants willhave only access to the Training set. They will develop their solutions based on theTraining set. After the final solution submission by the participants, the finalhackathon rankings will be decided by evaluation on the hidden test set. This is doneto ensure that the participants solutions generalize better on newer data.The evaluation metric we want to use for this hackathon will be Word Error Rate(WER). The WER will be computed between the actual translated text with thesolution generated text. The lower the WER the better the model.",
        Category: "Software",
        PS_Number: "SIH1456",
        Domain_Bucket: "Miscellaneous",
      },
      ...
      },
      {
        Organization: "Ministry of Power ",
        Problem_Statement_Title:
          "Creation of dedicated real time 'Procurement DataPortal'as well as 'Vendor Payment Data portal'tocapture all related data in respect of NEEPCO,SProcurements and Payments' includingProcurement from MSE Sector and procurement inGeM Portal",
        Description:
